...
jint Java_lab_galaxy_yahfa_HookMain_00024Utils_visiblyInit(JNIEnv *env, jclass clazz, jlong thread) {
    ...
    LOGI("thread is at %zx", (size_t)thread);
    MakeInitializedClassesVisiblyInitialized(classLinker, (void *)thread, 1);
    return 0;
}

JNINativeMethod yahfa_utils_methods[] ={
        [0] = {
                "visiblyInit",
                "(J)I",
                &Java_lab_galaxy_yahfa_HookMain_00024Utils_visiblyInit
        },
        [1] = {
                "shouldVisiblyInit",
                "()Z",
                &Java_lab_galaxy_yahfa_HookMain_00024Utils_shouldVisiblyInit
        },
        [2] = {
                "getThread",
                "()J",
